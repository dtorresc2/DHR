...
public class QuerysCitas {
    ...
    public void obtenerListadoCitasDia(final JSONObject jsonBody, QuerysCitas.VolleyOnEventListener callback) {
        mCallBack = callback;

        StringRequest stringRequest = new StringRequest(Request.Method.POST, mContext.getResources().getString(R.string.API) + "citas/consulta/dia",
                response -> mCallBack.onSuccess(response), error -> mCallBack.onFailure(error)) {
    ...
    public void obtenerListadoCitasCercanas(final JSONObject jsonBody, QuerysCitas.VolleyOnEventListener callback) {
        mCallBack = callback;

        StringRequest stringRequest = new StringRequest(Request.Method.POST, mContext.getResources().getString(R.string.API) + "citas/consulta/cerca",
                response -> mCallBack.onSuccess(response), error -> mCallBack.onFailure(error)) {
